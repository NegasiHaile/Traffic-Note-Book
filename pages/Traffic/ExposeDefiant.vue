    ...
    <div class="d-flex justify-content-center">
        <div class="col-12 col-md-8">
          ...
          <div class="card shadow-lg">
            ...
            <div class="card-body">
                <form class="row mt-1" @submit.prevent="saveDefiant">
  ...
  methods: {
    ...
    TrafficDtail() {
      ...
      var index = Accounts.findIndex(
        (Account) => Account.Email == this.logedin.email
      )
      ...
      this.NewDefiant.Recorder.FullName =
        Accounts[index].FName + ' ' + Accounts[index].MName
